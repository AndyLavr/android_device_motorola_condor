...
BOARD_CUSTOM_BOOTIMG_MK := device/motorola/condor/releasetools/mkbootimg.mk
...
TARGET_BOARD_INFO_FILE := device/motorola/condor/board-info.txt
...
COMMON_GLOBAL_CFLAGS += -DmotorolaROLA_UIDS -DQCOM_HARDWARE
TARGET_USES_motorolaROLA_LOG := true
TARGET_NR_SVC_SUPP_GIDS := 32

BOARD_EGL_CFG := device/motorola/condor/rootdir/system/lib/egl/egl.cfg

TARGET_USES_ION := true
USE_OPENGL_RENDERER := true

# Wifi related defines
# Thank you to contributors of github.com/CyanogenMod/android_device_motorolarola_qcom-common
...
TARGET_RECOVERY_FSTAB = device/motorola/condor/rootdir/fstab.qcom
